                ...
                <div class="page-title">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-left">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Dánh sách đơn hàng của bạn đã phê duyệt(chưa giao)</li>
                        </ol>
                    </nav>
                </div>
                ...
                @foreach($result as $user)
                    <div class="table">
                        <div class=" card-header bg-white">
                          <u style="color: #999999;" class="font-italic"> Đơn hàng của Bạn</u>  
                        </div>
                        <p style="margin-left:50px;">Tổng giá đơn hàng:{{number_format($user->total_price)}}Đ</p>
                        <a href="{{url(route('Cartdetail',$user->id))}}">
