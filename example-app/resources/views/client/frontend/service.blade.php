      ...
      <div class="col-md-8">
        <div class="row">
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{asset('client')}}/images/it_service/si1.png" alt="#"></div>
          ...
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{asset('client')}}/images/it_service/si2.png" alt="#"></div>
          ...
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{asset('client')}}/images/it_service/si3.png" alt="#"></div>
          ...
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{asset('client')}}/images/it_service/si4.png" alt="#"></div>
          ...
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{asset('client')}}/images/it_service/si5.png" alt="#"></div>
          ...
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{asset('client')}}/images/it_service/si6.png" alt="#"></div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 service_blog">
        <div class="full">
          <div class="service_img"> <img class="img-responsive" src="{{asset('client')}}/images/it_service/post-01.jpg" alt="#" /> </div>
      ...
      <div class="col-md-4 service_blog">
        <div class="full">
          <div class="service_img"> <img class="img-responsive" src="{{asset('client')}}/images/it_service/post-02.jpg" alt="#" /> </div>
          <div class="service_cont">
      ...
      <div class="col-md-4 service_blog">
        <div class="full">
          <div class="service_img"> <img class="img-responsive" src="{{asset('client')}}/images/it_service/post-03.jpg" alt="#" /> </div>
          <div class="service_cont">
