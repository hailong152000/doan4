                ...
                <section class="section">
                    ...
                    <div class="card">
                        <div class=" card-header bg-white">
                          <u style="color: #0dcaf0; cursor: pointer;" class="font-italic"> Bảng danh sách đơn hàng đã phê duyệt(chưa giao)</u>  
                        </div>
                        ...
                        <div class="mt-2 card-body">
                            <table class='table table-bordered ' id="table1">
                                ...
                                @foreach($result1 as $result1)
                                        <form action="{{ route('updatecart2',$result1->id)}}" method="POST">
                                            @csrf
                                        <a class="btn-trash" href=""> <i far fa-check-circle"> <button class="btn btn-primary type="submit">Giao Hàng</button></i></a>
                                        </form>
                                      @endforeach
                        </div>
                    </div>
